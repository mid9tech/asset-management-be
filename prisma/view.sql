...
SELECT
  ...
  SUM(CASE WHEN a."state" = 'NOT_AVAILABLE' THEN 1 ELSE 0 END)::int AS "notAvailable",
  SUM(CASE WHEN a."state" = 'WAITING_FOR_RECYCLING' THEN 1 ELSE 0 END)::int AS "waitingForRecycling",
